...
// --- Page-specific icons (not shared elsewhere) ---
const MailIcon = () => (
...
export default function ProfilePage() {
  ...
  const progressToNext = (totalActivities % 10) * 10;
      ...
      <div className="relative max-w-md mx-auto px-6 pt-12 flex flex-col items-center gap-8 animate-in slide-in-from-bottom-5 duration-700 fade-in">
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          <div className="relative group cursor-pointer">
            ...
            <div className="absolute bottom-0 right-0 bg-slate-800 border border-slate-700 text-slate-400 p-2 rounded-full hover:bg-slate-700 hover:text-white transition-colors z-20 shadow-lg">
              <EditIcon />
            </div>
          </div>

          <div className="text-center w-full">
            <h1 className="text-3xl font-black text-white tracking-tight mb-2">{profile?.username}</h1>
            <div className="flex flex-col items-center gap-2 max-w-[200px] mx-auto">
              ...
              <div className="w-full h-1.5 bg-slate-800 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-orange-500 to-amber-400 rounded-full transition-all duration-1000 shadow-[0_0_10px_rgba(249,115,22,0.5)]"
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          <div className="bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-2xl p-4 flex flex-col items-center relative overflow-hidden group hover:border-orange-500/30 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-900/20">
            ...
            <span className="text-3xl font-black text-white tracking-tight">{profile?.streak_count}</span>
            <span className="text-[10px] uppercase font-bold text-orange-400/80 tracking-widest">Day Streak</span>
          </div>
          <div className="bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-2xl p-4 flex flex-col items-center relative overflow-hidden group hover:border-blue-500/30 transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-900/20">
            <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-40 transition-opacity blur-[1px]">🧊</div>
            <span className="text-3xl mb-1 filter drop-shadow-[0_0_15px_rgba(59,130,246,0.6)]">🧊</span>
            <span className="text-3xl font-black text-white tracking-tight">{profile?.freeze_tokens}</span>
        ...
        <div className="w-full bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-3xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 relative z-10">
            ...
            <div className="text-[10px] font-mono font-medium text-slate-500 bg-slate-950/50 px-2 py-1 rounded-md border border-white/5">
        ...
        <div className="w-full space-y-4">
          ...
          <div className="bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-2xl overflow-hidden divide-y divide-white/5">
            <div className="flex items-center justify-between p-4 transition-colors hover:bg-white/5 group">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-slate-800/50 border border-slate-700 flex items-center justify-center text-slate-400 group-hover:text-white group-hover:border-slate-600 transition-all">
                  <MailIcon />
                </div>
