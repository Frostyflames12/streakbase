...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (success) navigate("/"); // ← navigate on success
  }
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="bg-slate-800/40 backdrop-blur-2xl rounded-3xl p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-white/10">
          ...
          <div className="flex flex-col items-center justify-center mb-10">
            ...
            <p className="text-slate-400 font-medium">Start your journey.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              <label className="text-slate-300 text-xs font-bold uppercase tracking-widest ml-1 mb-2 block">
                Username
              </label>
              <input
                name="username"
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-slate-400 text-sm">
              ...
              <Link
                to="/login"
                className="text-orange-400 hover:text-orange-300 font-bold decoration-2 underline-offset-4 hover:underline transition-all"
              >
                Sign In
              </Link>
            </p>
